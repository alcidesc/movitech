	...
	<section class="w3l-team-main team py-5" id="team">
        <div class="container py-lg-5">
            <div class="text-center mb-2">
				<h3 class="title-w3l mb-4"><span class="log">N</span>uestros <span class="log">P</span>roductos</h3>
				<div id="col-md-12">
            ...
            <div class="row team-row justify-content-center">
				...
				@else
					<div class="col-md-12" align="center">
						...
						<p class="title-w3l mb-4"><span class="log">P</span>roductos <span class="log">N</span>o <span class="log">E</span>ncontrados</p>
					</div>
				@endif
				<div class="col-md-12">
					{{ $productos->links() }} 
