            ...
            <div class="row">
                ...
                <div class="col-md-4"><br>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" wire:ignore id="precio" class="number form-control @error('precio') is-invalid @enderror" placeholder="Precio de Servicio" step="any" required>
                        @error('precio')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4"><br>
                    <label>Precio de Servicio 2:</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-money-bill-wave"></i></span>
                        </div>
                        <input type="text" wire:ignore id="precio2" class="number form-control @error('precio2') is-invalid @enderror" placeholder="Precio de Servicio" required>
                        @error('precio2')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4"><br>
                    <label>Precio de Servicio3:</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-money-bill-wave"></i></span>
                        </div>
                        <input type="text" wire:ignore id="precio3" class="number form-control @error('precio3') is-invalid @enderror" placeholder="Precio de Servicio" required>
                        @error('precio3')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4"><br>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select id="iva" class="form-control @error('iva') is-invalid @enderror" wire:model="iva">
